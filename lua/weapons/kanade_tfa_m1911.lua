...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound 					= Sound("KANADE_TFA_M1911.1") -- This is the sound of the weapon, when you shoot.
...
--[[VIEWMODEL]]--
SWEP.ViewModel          = "models/weapons/kanade_tfa/view/v_m1911.mdl" --Viewmodel path
...
--[[WORLDMODEL]]--
SWEP.WorldModel         = "models/weapons/kanade_tfa/world/w_1911.mdl" -- Weapon world model path
...
SWEP.IronSightsPos = Vector(-1.85, 0, 0.45) --Change this, using SWEP Creation Kit preferably
SWEP.IronSightsAng = Vector(0, 0.05, 0) --Change this, using SWEP Creation Kit preferably
...
SWEP.VElements = {
	...
	laser_beam = {
		...
		bone = "A_Suppressor", rel = "",
		pos = Vector(0, 0, -0.6), angle = Angle(0, 90, 0), size = Vector(2, 0.5, 0.5),
		color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0,
