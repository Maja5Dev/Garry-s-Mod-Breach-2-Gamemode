...
SWEP.PrintName 				= "M590"       -- Weapon name (Shown on HUD)
...
--[[VIEWMODEL]]--
SWEP.ViewModel          = "models/weapons/kanade_tfa/view/v_m590.mdl" --Viewmodel path
...
--[[WORLDMODEL]]--
SWEP.WorldModel         = "models/weapons/kanade_tfa/world/w_m590.mdl" -- Weapon world model path
...
SWEP.VElements = {
	...
	suppressor = {
		type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_suppressor_sec2.mdl",
	...
	laser = {
		type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_laser_sec_shotgun.mdl",
	...
	laser_beam = {
		...
		pos = Vector(0, -2.5, 0), angle = Angle(0, 0, 0), size = Vector(2, 0.5, 0.5),
		color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0,
		bodygroup = {}, active = false
	},
}
