...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound 					= Sound("KANADE_TFA_MP5K.1") -- This is the sound of the weapon, when you shoot.
SWEP.Primary.SilencedSound 			= Sound("KANADE_TFA_MP5K.2") -- This is the sound of the weapon, when silenced.
...
--[[VIEWMODEL]]--
SWEP.ViewModel          = "models/weapons/kanade_tfa/view/v_mp5kpdw.mdl" --Viewmodel path
...
--[[WORLDMODEL]]--
SWEP.WorldModel         = "models/weapons/kanade_tfa/world/w_mp5k.mdl" -- Weapon world model path
...
SWEP.IronSightsPos = Vector(-2.305, 2, 0.625) --Change this, using SWEP Creation Kit preferably
SWEP.IronSightsAng = Vector(0, 0, 0) --Change this, using SWEP Creation Kit preferably

SWEP.IronSightsPos_Kobra = Vector(-2.32, 2, 0)
SWEP.IronSightsAng_Kobra = Vector(-1.2, 0, 0)
SWEP.Secondary.IronFOV_Kobra = 70

SWEP.IronSightsPos_EOTech = Vector(-2.32, 2, 0)
SWEP.IronSightsAng_EOTech = Vector(-1.2, 0, 0)
SWEP.Secondary.IronFOV_EOTech = 70

SWEP.IronSightsPos_RDS = Vector(-2.32, 2, 0)
SWEP.IronSightsAng_RDS = Vector(-1.2, 0, 0)
