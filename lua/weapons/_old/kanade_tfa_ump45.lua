...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound 					= Sound("KANADE_TFA_UMP45.1") -- This is the sound of the weapon, when you shoot.
SWEP.Primary.SilencedSound 			= Sound("KANADE_TFA_UMP45.2") -- This is the sound of the weapon, when silenced.
...
--Firing Cone Related
SWEP.Primary.Spread = 0.007 --This is hip-fire acuracy.  Less is more (1 is horribly awful, .0001 is close to perfect)
...
--[[VIEWMODEL]]--
SWEP.ViewModel          = "models/weapons/kanade_tfa/view/v_ump45.mdl" --Viewmodel path
...
--[[WORLDMODEL]]--
SWEP.WorldModel         = "models/weapons/kanade_tfa/world/w_ump45.mdl" -- Weapon world model path
...
SWEP.IronSightsPos = Vector(-2.6, 2, 0.6) --Change this, using SWEP Creation Kit preferably
SWEP.IronSightsAng = Vector(0.52, 0, 0) --Change this, using SWEP Creation Kit preferably

SWEP.IronSightsPos_Kobra = Vector(-2.6, 2, 0)
SWEP.IronSightsAng_Kobra = Vector(0, 0, 0)
SWEP.Secondary.IronFOV_Kobra = 75

SWEP.IronSightsPos_EOTech = Vector(-2.6, 2, 0)
SWEP.IronSightsAng_EOTech = Vector(0, 0, 0)
SWEP.Secondary.IronFOV_EOTech = 75

SWEP.IronSightsPos_RDS = Vector(-2.6, 2, 0)
...
SWEP.VElements = {
	...
	["sight_kobra"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_optic_kobra_l.mdl", bone = "A_Optic", rel = "", pos = Vector(0, 0, 1), angle = Angle(90, 90, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false, bonemerge = true },
	...
	["laser"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_laser_band.mdl", bone = "A_Suppressor", rel = "", pos = Vector(0, 4.5, 0), angle = Angle(0, 90, -90), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = true, active = false },
...
SWEP.WElements = {
	...
	["sights_folded"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/w_flipup1.mdl", bone = "ATTACH_Standard", rel = "ref", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = true, active = false},
