...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound 					= Sound("KANADE_TFA_BERETTA_M9.1") -- This is the sound of the weapon, when you shoot.
SWEP.Primary.SilencedSound 			= Sound("KANADE_TFA_BERETTA_M9.2") -- This is the sound of the weapon, when silenced.
...
--[[VIEWMODEL]]--
SWEP.ViewModel          = "models/weapons/kanade_tfa/view/v_beretta.mdl" --Viewmodel path
...
--[[WORLDMODEL]]--
SWEP.WorldModel         = "models/weapons/kanade_tfa/world/w_m9.mdl" -- Weapon world model path
...
SWEP.IronSightsPos = Vector(-1.865, 0, 0.55) --Change this, using SWEP Creation Kit preferably
...
SWEP.VElements = {
	...
	laser_beam = {
		...
		bone = "A_Suppressor", rel = "",
		pos = Vector(0, 0, -0.8), angle = Angle(0, 90, 0), size = Vector(2, 0.5, 0.5),
		color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0,
