...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound 					= Sound("KANADE_TFA_RPK.1") -- This is the sound of the weapon, when you shoot.
SWEP.Primary.SilencedSound 			= Sound("KANADE_TFA_RPK.2") -- This is the sound of the weapon, when silenced.
...
--[[VIEWMODEL]]--
SWEP.ViewModel          = "models/weapons/kanade_tfa/view/v_rpk.mdl" --Viewmodel path
...
--[[WORLDMODEL]]--
SWEP.WorldModel         = "models/weapons/kanade_tfa/world/w_rpk.mdl" -- Weapon world model path
...
SWEP.IronSightsPos = Vector(-2.3, 2, 0.08) --Change this, using SWEP Creation Kit preferably
SWEP.IronSightsAng = Vector(0.9, 0, 0) --Change this, using SWEP Creation Kit preferably

SWEP.IronSightsPos_Kobra = Vector(-2.31, 2, -0.96)
SWEP.IronSightsAng_Kobra = Vector(0, 0, 0)
SWEP.Secondary.IronFOV_Kobra = 65

SWEP.IronSightsPos_EOTech = Vector(-2.31, 2, -0.96)
SWEP.IronSightsAng_EOTech = Vector(0, 0, 0)
SWEP.Secondary.IronFOV_EOTech = 65

SWEP.IronSightsPos_RDS = Vector(-2.31, 2, -0.96)
SWEP.IronSightsAng_RDS = Vector(0, 0, 0)
SWEP.Secondary.IronFOV_RDS = 60

SWEP.IronSightsPos_2XRDS = Vector(-2.31, 2, -0.96)
SWEP.IronSightsAng_2XRDS = Vector(0, 0, 0)
SWEP.Secondary.IronFOV_2XRDS = 55

--Vector(-2.31, 2, -0.96)
SWEP.IronSightsPos_C79 = Vector(-2.31, 2, -1.4)
...
SWEP.VElements = {
	...
	suppressor = {
		type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_suppressor_pistol.mdl",
	...
	laser_beam = {
		...
		pos = Vector(0, -1.5, 0), angle = Angle(0, 0, 0), size = Vector(2, 0.5, 0.5),
		color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0,
		bodygroup = {}, active = false
	},
}
...
SWEP.WElements = {
	...
	suppressor = {
		type = "Model", model = "models/weapons/tfa_ins2/upgrades/w_sil_pistol.mdl",
