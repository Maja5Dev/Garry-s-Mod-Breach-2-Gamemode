...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound 					= Sound("KANADE_TFA_M4A1.1") -- This is the sound of the weapon, when you shoot.
SWEP.Primary.SilencedSound 			= Sound("KANADE_TFA_M4A1.2") -- This is the sound of the weapon, when silenced.
...
--[[VIEWMODEL]]--
SWEP.ViewModel          = "models/weapons/kanade_tfa/view/v_m4a1.mdl" --Viewmodel path
...
--[[WORLDMODEL]]--
SWEP.WorldModel         = "models/weapons/kanade_tfa/world/w_m4a1.mdl" -- Weapon world model path
...
SWEP.IronSightsPos = Vector(-2.488, 2, 0.45) --Change this, using SWEP Creation Kit preferably
SWEP.IronSightsAng = Vector(0.3, 0, 0) --Change this, using SWEP Creation Kit preferably

SWEP.IronSightsPos_Folded = Vector(-2.5, 0, 0.47)
SWEP.IronSightsAng_Folded = Vector(0.3, 0, 0)

SWEP.IronSightsPos_Kobra = Vector(-2.488, 0, 0.45)
SWEP.IronSightsAng_Kobra = Vector(-0.3, 0, 0)
SWEP.Secondary.IronFOV_Kobra = 80

SWEP.IronSightsPos_EOTech = Vector(-2.488, 0, 0.45)
SWEP.IronSightsAng_EOTech = Vector(-0.3, 0, 0)
SWEP.Secondary.IronFOV_EOTech = 80

SWEP.IronSightsPos_RDS = Vector(-2.488, 0, 0.45)
SWEP.IronSightsAng_RDS = Vector(-0.3, 0, 0)
SWEP.Secondary.IronFOV_RDS = 80
...
SWEP.Attachments = {
	...
	[7] = { offset = { 0, 0 }, atts = { "kanade_att_sights_folded", "ins2_si_kobra", "ins2_si_eotech", "ins2_si_rds" }, order = 2, sel = 1 },
