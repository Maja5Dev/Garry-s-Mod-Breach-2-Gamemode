...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound 					= Sound("KANADE_TFA_MK18.1") -- This is the sound of the weapon, when you shoot.
SWEP.Primary.SilencedSound 			= Sound("KANADE_TFA_MK18.2") -- This is the sound of the weapon, when silenced.
...
--[[VIEWMODEL]]--
SWEP.ViewModel          = "models/weapons/kanade_tfa/view/v_mk18.mdl" --Viewmodel path
...
--[[WORLDMODEL]]--
SWEP.WorldModel         = "models/weapons/kanade_tfa/world/w_mk18.mdl" -- Weapon world model path
...
SWEP.IronSightsPos = Vector(-2.555, 2, 0.82) --Change this, using SWEP Creation Kit preferably
SWEP.IronSightsAng = Vector(0, 0, 0) --Change this, using SWEP Creation Kit preferably

SWEP.IronSightsPos_Kobra = Vector(-2.5, 2, 0.4)
SWEP.IronSightsAng_Kobra = Vector(0, 0.13, 0)
SWEP.Secondary.IronFOV_Kobra = 70

SWEP.IronSightsPos_EOTech = Vector(-2.5, 2, 0.4)
SWEP.IronSightsAng_EOTech = Vector(0, 0.13, 0)
SWEP.Secondary.IronFOV_EOTech = 70

SWEP.IronSightsPos_RDS = Vector(-2.5, 2, 0.4)
SWEP.IronSightsAng_RDS = Vector(0, 0.13, 0)
...
SWEP.VElements = {
	...
	laser = {
		type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_laser_band.mdl",
	...
	laser_beam = {
		...
		pos = Vector(0, -2, 0), angle = Angle(0, 0, 0), size = Vector(2, 0.5, 0.5),
		color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0,
...
SWEP.Attachments = {
	...
	[7] = { offset = { 0, 0 }, atts = { "ins2_si_kobra", "ins2_si_eotech", "ins2_si_rds" }, order = 2 },
