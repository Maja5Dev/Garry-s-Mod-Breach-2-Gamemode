...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound 					= Sound("KANADE_TFA_M16A4.1") -- This is the sound of the weapon, when you shoot.
SWEP.Primary.SilencedSound 			= Sound("KANADE_TFA_M16A4.2") -- This is the sound of the weapon, when silenced.
...
--Firing Cone Related
SWEP.Primary.Spread = 0.006 --This is hip-fire acuracy.  Less is more (1 is horribly awful, .0001 is close to perfect)
...
--[[VIEWMODEL]]--
SWEP.ViewModel          = "models/weapons/kanade_tfa/view/v_m16a3.mdl" --Viewmodel path
...
--[[WORLDMODEL]]--
SWEP.WorldModel         = "models/weapons/kanade_tfa/world/w_m16.mdl" -- Weapon world model path
...
SWEP.IronSightsPos = Vector(-2.495, 2, 0.6) --Change this, using SWEP Creation Kit preferably
SWEP.IronSightsAng = Vector(0, 0, 0) --Change this, using SWEP Creation Kit preferably

SWEP.IronSightsPos_Folded = Vector(-2.5, 0, 0.45)
SWEP.IronSightsAng_Folded = Vector(0.3, 0, 0)

SWEP.IronSightsPos_Kobra = Vector(-2.488, 0, 0.35)
SWEP.IronSightsAng_Kobra = Vector(0, 0, 0)
SWEP.Secondary.IronFOV_Kobra = 70

SWEP.IronSightsPos_EOTech = Vector(-2.488, 0, 0.35)
SWEP.IronSightsAng_EOTech = Vector(0, 0, 0)
SWEP.Secondary.IronFOV_EOTech = 70

SWEP.IronSightsPos_RDS = Vector(-2.488, 0, 0.35)
SWEP.IronSightsAng_RDS = Vector(0, 0, 0)
SWEP.Secondary.IronFOV_RDS = 70

SWEP.IronSightsPos_2XRDS = Vector(-2.488, 0, 0.35)
SWEP.IronSightsAng_2XRDS = Vector(0, 0, 0)
SWEP.Secondary.IronFOV_2XRDS = 55

SWEP.IronSightsPos_C79 = Vector(-2.488, 0, -0.09)
...
SWEP.VElements = {
	sights_folded = {
		type = "Model", model = "models/weapons/upgrades/a_carryhandle_m4.mdl",
		bone = "A_Optic", rel = "",
		pos = Vector(0, -0.245, 0.159), angle = Angle(0, -90, 0), size = Vector(0.611, 0.611, 0.611),
...
SWEP.WElements = {
	sights_folded = {
		type = "Model", model = "models/weapons/tfa_ins2/upgrades/w_flipup1.mdl",
		bone = "ATTACH_Standard", rel = "ref",
		pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(1, 1, 1),
		color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0,
		bodygroup = {}, bonemerge = true, active = false
	},
...
SWEP.Attachments = {
	...
	[7] = { offset = { 0, 0 }, atts = { "kanade_att_sights_folded", "ins2_si_kobra", "ins2_si_eotech", "ins2_si_rds", "ins2_si_2xrds", "ins2_si_c79" }, order = 2, sel = 1 },
