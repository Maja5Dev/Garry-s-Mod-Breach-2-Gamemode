...
SWEP.Category 				= "Breach 2 Weapons" --The category.  Please, just choose something generic or something I've already done if you plan on only doing like one swep..
SWEP.Manufacturer 			= nil --Gun Manufactrer (e.g. Hoeckler and Koch)
SWEP.Author 				= "Kanade" --Author Tooltip
...
--Firing Cone Related
SWEP.Primary.Spread = 0.008 --This is hip-fire acuracy.  Less is more (1 is horribly awful, .0001 is close to perfect)
...
--[[VIEWMODEL]]--
SWEP.ViewModel          = "models/weapons/c_fn_fal.mdl" --Viewmodel path
...
--[[WORLDMODEL]]--
SWEP.WorldModel         = "models/weapons/w_fn_fal.mdl" -- Weapon world model path
...
SWEP.IronSightsPos = Vector(-2.73, 0, 1) --Change this, using SWEP Creation Kit preferably
SWEP.IronSightsAng = Vector(-0.4, 0.02, 0) --Change this, using SWEP Creation Kit preferably

SWEP.IronSightsPos_Kobra = Vector(-2.719, -1, -0.49)
SWEP.IronSightsAng_Kobra = Vector(0, 0, 0)
SWEP.Secondary.IronFOV_Kobra = 75

SWEP.IronSightsPos_EOTech = Vector(-2.717, -1, -0.486)
SWEP.IronSightsAng_EOTech = Vector(0, 0, 0)
SWEP.Secondary.IronFOV_EOTech = 75

SWEP.IronSightsPos_RDS = Vector(-2.717, -1.2, -0.486)
SWEP.IronSightsAng_RDS = Vector(0, 0, 0)
SWEP.Secondary.IronFOV_RDS = 70

SWEP.IronSightsPos_2XRDS = Vector(-2.7148, -3, -0.488)
SWEP.IronSightsAng_2XRDS = Vector(0, 0, 0)
SWEP.Secondary.IronFOV_2XRDS = 80

--Vector(-2.48, 2, -0.66)
SWEP.IronSightsPos_C79 = Vector(-2.7168, -3.5, -0.85)
SWEP.IronSightsAng_C79 = Vector(0, 0, 0)
SWEP.Secondary.IronFOV_C79 = 86

--[[INSPECTION]]--
SWEP.InspectPos = Vector(8,0,2) --Replace with a vector, in style of ironsights position, to be used for inspection
SWEP.InspectAng = Vector(0,40,10) --Replace with a vector, in style of ironsights angle, to be used for inspection
...
SWEP.VElements = {
	mag = {
		type = "Model",
		model = "models/weapons/tfa_ins2/upgrades/a_magazine_fal_20.mdl",
		bone = "Magazine",
		rel = "",
		pos = Vector(0, 0, 0),
		angle = Angle(0, 0, 0),
	...
	mag_ext = {
		type = "Model",
		model = "models/weapons/tfa_ins2/upgrades/a_magazine_fal_l1a1_30.mdl",
		bone = "Magazine",
		rel = "",
		pos = Vector(0, 0, 0),
		angle = Angle(0, 0, 0),
	...
	sights_folded = {
		type = "Model",
		model = "models/weapons/tfa_ins2/upgrades/a_standard_fal.mdl",
		bone = "A_Optic", rel = "",
		pos = Vector(0, -0.98, -3.2),
		angle = Angle(90, 0, 90),
		size = Vector(0.88, 0.85, 0.92),
		color = Color(255, 255, 255, 255),
		surpresslightning = false,
		material = "",
		skin = 0,
	...
	rail_sights = {
		type = "Model",
		model = "models/weapons/tfa_ins2/upgrades/a_modkit_fal.mdl",
		bone = "A_Modkit",
		rel = "",
		pos = Vector(0, 0, 0),
		angle = Angle(0, 0, 0),
	...
	sight_kobra = {
		type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_optic_kobra_l.mdl",
		bone = "A_Optic", rel = "",
		pos = Vector(0, 0, 1), angle = Angle(90, 90, 0), size = Vector(1, 1, 1),
		color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0,
		bodygroup = {}, active = false, bonemerge = true
	},
	sight_kobra_lens = (TFA.INS2 and TFA.INS2.GetHoloSightReticle) and TFA.INS2.GetHoloSightReticle("sight_kobra") or nil,
	
	sight_eotech = {
		type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_optic_eotech.mdl",
		bone = "A_Optic", rel = "",
		pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(0.5, 0.5, 0.5),
		color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0,
		bodygroup = {}, active = false, bonemerge = true
	},
	...
	sight_rds = {
		type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_optic_aimpoint.mdl",
		bone = "A_Optic", rel = "",
		pos = Vector(0, 0, 0), angle = Angle(90, 90, 0), size = Vector(0.9, 0.9, 0.9),
		color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0,
		bodygroup = {}, active = false, bonemerge = true
	},
	...
	scope_2xrds = {
		type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_optic_aimp2x.mdl",
		bone = "A_Optic", rel = "",
		pos = Vector(0, 0, 0), angle = Angle(90, 90, 0), size = Vector(0.95, 0.95, 0.95),
		color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0,
		bodygroup = {}, active = false, bonemerge = true
	},
	scope_2xrds_lens = {
		type = "Model", model = "models/rtcircle.mdl",
		bone = "A_Optic", rel = "scope_2xrds",
		pos = Vector(0, 0, -0.108), angle = Angle(-90, 0, -90), size = Vector(0.3, 0.3, 0.3),
		color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0,
		bodygroup = {}, active = false
	},
	scope_c79 = {
		type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_optic_elcan.mdl",
		bone = "A_Optic", rel = "",
		pos = Vector(0, 0, 0.3), angle = Angle(90, 90, 0), size = Vector(0.75, 0.85, 0.85),
		color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0,
		bodygroup = {}, active = false, bonemerge = true
	},
	scope_c79_lens = {
		type = "Model", model = "models/rtcircle.mdl",
		bone = "A_Optic", rel = "scope_c79",
		pos = Vector(0, -0.08, 0), angle = Angle(0, 0, 0), size = Vector(0.5, 0.5, 0.5),
		color = Color(255, 255, 255, 255), surpresslightning = false, material = "!tfa_rtmaterial", skin = 0,
		bodygroup = {}, active = false
	},
	suppressor = {
		type = "Model",
		--model = "models/weapons/tfa_ins2/upgrades/a_suppressor_pistol.mdl",
		model = "models/weapons/tfa_ins2/upgrades/a_suppressor_sec2.mdl",
		--model = "models/weapons/tfa_ins2/upgrades/a_suppressor_sec.mdl",
		bone = "A_Suppressor", rel = "",
		pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(1, 1, 1),
		color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0,
		bodygroup = {}, bonemerge = true, active = false
	},
	laser = {
		type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_laser_rail.mdl",
		bone = "A_Underbarrel", rel = "",
		pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(1, 1, 1),
		color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0,
		bodygroup = {}, bonemerge = true, active = false
	},
	laser_beam = {
		type = "Model", model = "models/tfa/lbeam.mdl",
		bone = "LaserPistol", rel = "laser",
		pos = Vector(0, -1.25, 0), angle = Angle(0, 0, 0), size = Vector(2, 0.5, 0.5),
		color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0,
		bodygroup = {}, active = false
	},
}
...
SWEP.WElements = {
	sight_kobra = {
		type = "Model", model = "models/weapons/tfa_ins2/upgrades/w_kobra.mdl",
		bone = "ATTACH_ModKit", rel = "ref",
		pos = Vector(-36.5, 0, -19.2), angle = Angle(0, 0, 0), size = Vector(0.9, 0.9, 0.9),
		color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0,
		bodygroup = {}, bonemerge = true, active = false
	},
	sight_eotech = {
		type = "Model", model = "models/weapons/tfa_ins2/upgrades/w_eotech.mdl",
		bone = "ATTACH_ModKit", rel = "ref",
		pos = Vector(2.118, 0, -13.3), angle = Angle(1, 0, 0), size = Vector(0.845, 0.845, 0.845),
		color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0,
		bodygroup = {}, bonemerge = true, active = false
	},
	sight_rds = {
		type = "Model", model = "models/weapons/tfa_ins2/upgrades/w_aimpoint.mdl",
		bone = "ATTACH_ModKit", rel = "ref",
		pos = Vector(-53.416, 0.079, -11), angle = Angle(0, 0, 0), size = Vector(1, 1, 1),
		color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0,
		bodygroup = {}, bonemerge = true, active = false
	},
	scope_2xrds = {
		type = "Model", model = "models/weapons/tfa_ins2/upgrades/w_magaim.mdl",
		bone = "ATTACH_ModKit", rel = "ref",
		pos = Vector(-52.2, 0.079, -11), angle = Angle(0, 0, 0), size = Vector(1, 1, 1),
		color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0,
		bodygroup = {}, bonemerge = true, active = false
	},
	scope_c79 = {
		type = "Model", model = "models/weapons/tfa_ins2/upgrades/w_elcan.mdl",
		bone = "ATTACH_ModKit", rel = "ref",
		pos = Vector(-45.867, 0, -6.3), angle = Angle(0, 0, 0), size = Vector(0.7, 0.7, 0.7),
		color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0,
		bodygroup = {}, bonemerge = true, active = false
	},
	suppressor = {
		type = "Model",
		model = "models/weapons/tfa_ins2/upgrades/w_sil_pistol.mdl",
		bone = "ATTACH_Muzzle", rel = "ref",
		pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(1, 1, 1),
		color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0,
		bodygroup = {}, bonemerge = true, active = false
	},
	laser = {
		type = "Model", model = "models/weapons/tfa_ins2/upgrades/w_laser_sec.mdl",
		bone = "ATTACH_Laser", rel = "ref",
		pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(1, 1, 1),
		color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0,
		bodygroup = {}, bonemerge = true, active = false
	},
...
SWEP.ViewModelBoneMods = {
	["A_Optic"] = { scale = Vector(0.88, 0.88, 0.88), pos = Vector(0, 0, 0.132), angle = Angle(0, 0, 0) },
	["A_Suppressor"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0.2, 0), angle = Angle(0, 0, 0) },
	["A_LaserFlashlight"] = { scale = Vector(0.9, 0.9, 0.9), pos = Vector(-0.15, 0, -0.1), angle = Angle(0, 0, 160) }, -- Angle(0, 0, -20)
