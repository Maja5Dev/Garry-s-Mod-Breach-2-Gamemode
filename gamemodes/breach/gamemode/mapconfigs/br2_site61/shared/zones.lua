...
MAPCONFIG.ZONES.HCZ = {
	...
	},
	{
		...
		color 						= Color(0,0,255,50),
		sanity 						= -1,
		examine_info 				= "You are in the Heavy Containment Zone tunnels",
		zone_temp 					= ZONE_TEMP_COLD,
		scp_106_can_tp 				= true,
	},
	{
		name 						= "HCZ Warhead Control",
...
MAPCONFIG.ZONES.OUTSIDE = {
	{
		...
		fog_enabled 				= true,
		fog_mul						= 1.1,
		fog_color					= Color(10, 10, 10),
		use_general_ambients 		= false,
		color 						= Color(255,0,255,50),
		sanity 						= 1,
		examine_info 				= "You are outside the facility",
