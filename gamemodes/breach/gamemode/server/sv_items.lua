...
BR2_SCP_294_OUTCOMES = {
	{
		...
		type = 2,
		func = function(ply, info, text)
			scp_294_func(ply, info, text)
		end,
		use = function(ply)
			ply:PrintMessage(HUD_PRINTTALK, "There is nothing to drink in the cup.")
		end
	},
	{
		texts = {"water"},
		...
		use = function(ply)
			ply:PrintMessage(HUD_PRINTTALK, "Well, that was refreshing.")
			ply:AddThirst(-15)
		end
	},
	{
