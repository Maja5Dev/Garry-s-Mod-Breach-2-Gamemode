...
br2_add_cvar("br2_time_decontamination", "50", "Time for the LCZ deconatamination to start in % of round time")
...
br2_add_cvar("br2_035_decay_speed", "5", "Every how many seconds lower 035's health by 1%")
